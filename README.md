...
Con el entorno virtual activado, inicia Jupyter desde la raíz del repositorio:
...
El código fuente se distribuye como el paquete `bank_customer`, ubicado en
`src/bank_customer`. Tras instalar el proyecto en modo editable, puede
importarse desde scripts, notebooks y pruebas:
